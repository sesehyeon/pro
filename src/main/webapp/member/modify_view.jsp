...
<c:set var="dto" value="${dao.getMemberDetail(param.num)}"/>
	...
	<div class="wrapper">
		...
		<form name="modifyForm" action="modify.jsp" method="post">
			...
			<table>
				...
				<tbody>
					<tr>
						<th>아이디</th><td><input type="text" name="id" data-check-type="n-e" data-check-length="3~10" value="${dto.id}" disabled></td>
					</tr>
					<tr>
						<th>비밀번호</th><td><input type="password" name="password" data-check-type="n-e-s" data-check-length="4~20" value="${dto.password}"></td>
					</tr>
					<tr>
						<th>비밀번호 확인</th><td><input type="password" name="checkPassword" data-check-type="n-e-s" data-check-length="4~20" value="${dto.password}"></td>
					</tr>
					<tr>
						<th>이름</th><td><input type="text" name="name" data-check-type="k" data-check-length="2~10" value="${dto.name}"></td>
					</tr>
					<tr>
						<th>전화번호</th><td><input type="text" name="phone" data-check-type="p" data-check-length="0~11" value="${dto.phone}"></td>
					</tr>
					<tr>
						<th>주소</th><td><input type="text" name="address" data-check-length="0~100"  value="${dto.address}"></td>
					</tr>
					<tr>
						<td colspan="2" style="text-align:center;padding: 20px;border: none;">
							<input type="button" value="수정" onclick="modify();">
							<input type="button" value="회원목록" onclick="goList(document.modifyForm);">
						</td>
					</tr>	
				</tbody>
			</table>
...
<script type="text/javascript">
	document.body.onload = function() {
		injectEvent(document.modifyForm);
	}
	...
	function checkPassword() {
		var checkPassword = document.modifyForm.checkPassword;
		var password = document.modifyForm.password;
